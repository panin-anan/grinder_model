...
def main():
    ...
    rpm_range = np.arange(9000, 11001, 500)  # from 8500 to 10000 in steps of 500
    force_range = np.arange(5, 5.5, 1)  # from 3 to 9 in steps of 1
    time_range = np.arange(10, 10.4, 0.5)
