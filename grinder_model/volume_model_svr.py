...
def main():
    ...
    #save model
    save_model(best_model, best_scaler, folder_name='saved_models', modelname='volume_model_svr_W15_testoldwear.pkl', scalername='volume_scaler_svr_W15_testoldwear.pkl')
